                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3 col-lg-6">
                            ...
                            <div class="form-check form-check-custom form-check-solid mb-2">
                                <input class="form-check-input" v-model="data.listmenu" value="permintaan-penawaran" type="checkbox" value="" id="permintaan-penawaran"/>
                            ...
                            <div class="form-check form-check-custom form-check-solid mb-2">
                                <input class="form-check-input" v-model="data.listmenu" value="penawaran" type="checkbox" value="" id="penawaran"/>
