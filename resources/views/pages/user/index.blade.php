        ...
        <div class="col-12 mb-md-5 mb-xl-10">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">List User Login</h3>
                    <div class="card-toolbar">
                        <a href="{{route('user.create')}}" class="btn btn-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Tambah User Login</a>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	$('body').on('click', '.delete', function () {
		if (confirm("Are You sure want to delete the record?") == true) {
			var id = $(this).data('id');
			...
			$.ajax({
				...
				success: function(res){
					if (res.result == 'success') {
						...
						$('#tabel_master_driver').DataTable().ajax.url("{{ route('user.data') }}").load();
					}
				}
			});
		}
